								...
								<ul
									...
									<li class="clearfix">
										<dd>
											<strong></strong><font class="shop"
												style="font-size: 30px; font-weight: bold; color: #0da944;"
									...
									<li class="clearfix">
										<dd style="padding-bottom: 0;">
											...
											<strong>商品总价：</strong>
											<font id="ECS_GOODS_AMOUNT" class="shop"><span
												id="jiage">${requestScope.goods.shichangjia }</span>元</font>
										</dd>
										<div class="blank"></div>
									</li>
									<style>
	...
	-moz-border-radius: 3px;
									...
									<li class="padd"
										...
										<dd style="height: 35px;">
										 库存 ${goods.kucun }      查看 ${goods.viewcount }    
											<a
						...
						<div class="box" style="margin: 15px 0; border: 1px solid #ddd;">
							<div class="box_5">
								<h4 style="height: 40px; width: 100%; background: #F7F7F7;">
									<ul id="com_b">
										<li style="color: #fff; background: #0da944; cursor: pointer;">
											商品介绍
										</li>
...
$("#com_b li").click(function(){
  $(this).css({"color":"#fff","background":"#0da944","cursor":"pointer"}).siblings().css({"color":"#444","background":"#F7F7F7","cursor":"pointer"});
})
...
function changePrice(){
   ...
   document.getElementById("jiage").innerText = total;
 		 ...
 		 <div class="blank5"></div>
									<blockquote style="" class="com_h_1">
										<div id="ECS_COMMENT">
											<div class="box">
												<div class="box_1">
													<h3>
													...
													<div class="boxCenterList clearfix" style="height: 1%;">
														<ul class="comments">
														 <c:forEach items="${pinglunList}" var="pinglun">
															<li class="word" style="margin-left:13px;    line-height:30px; font-size: small;text-align: left;font-weight: normal"  >
																<font>${pinglun.plr}</font>
																<font>(${pinglun.plsj})</font>
																<br>
																	${pinglun.plnr}
																	<br>
																	回复：${pinglun.replays}
