...
<html>
    ...
    <script type="text/javascript">
            ...
            function toEidtAddress(id){
               window.location.href = '<%=path%>/user/toeadress?id=' + id;
            }
             function deladdress(id){
               window.location.href = '<%=path%>/user/delAddress?id=' + id;
            }
             function mr(id){
               window.location.href = '<%=path%>/user/mrAddress?id=' + id;
            }
...
<c:forEach items="${requestScope.addressList}" var="address">
    ...
    <form action="<%=path %>/user/saveAddress" method="post" name="form2"  style="margin-bottom: 10px;">
              <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
                <tbody> 
                                <tr>
