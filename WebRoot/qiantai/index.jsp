...
.indexFocus #picBtn span.current {
	background: #c00;
}
						...
						<ul id="focusPicList">
							<li style="display: inline;">
								<a href="#" target="_blank"><img
										src="<%=webpath%>/images/1442259738304706843.jpg" height="320"
										width="1200">
								</a><span></span>
							</li>
<li style="display: inline;">
								<a href="#" target="_blank"><img
										src="<%=webpath%>/images/1442259738304706842.jpg" height="320"
										width="1200">
								</a><span></span>
							</li>
...
<li style="display: inline;">
								<a href="#" target="_blank"><img
										src="<%=webpath%>/images/1442259738304706841.jpg" height="320"
										width="1200">
								</a><span></span>
							</li>
			...
			<div class="box cat_goods">
				...
				<div class="box_1 cat_goods_box">
					<div class="clearfix goodsBox" style="border: none;">
						...
						<c:forEach items="${requestScope.newList}" var="goods" begin="0" end="4"
							varStatus="sta">
							...
							<div class=""
								...
								<div style="position: relative;">
									<a
										href="<%=path%>/goods/goodsDetailQian?id=${goods.id }&cid=${goods.catelogId}"
										class="hot_pic" target="_blank"> <img
											style="width: 208px; height: 208px;"
											src="<%=path%>/${goods.fujian }" class="goodsimg"> </a>
									<span
								...
								<p style="margin-top: 8px;">
									<a
										...
										href="<%=path%>/goods/goodsDetailQian?id=${goods.id }&cid=${goods.catelogId}">${goods.mingcheng }</a>
								</p>
			...
			<div class="box cat_goods">
				...
				<div class="box_1 cat_goods_box">
					<div class="clearfix goodsBox" style="border: none;">
						...
						<c:forEach items="${requestScope.topxlList}" var="goods"
							varStatus="sta">



							<div class="goodsItem" style="width: 195px;">
								<div style="position: relative;">
									<a
										href="<%=path%>/goods/goodsDetailQian?id=${goods.id }&cid=${goods.catelogId}"
										class="hot_pic" target="_blank"> <img style="width: 208px; height: 208px;"
											src="<%=path%>/${goods.fujian }" class="goodsimg"> </a>
									<span
										style="height: 48px; width: 48px; display: block; position: absolute; top: -15px; right: 0; z-index: 2000;"></span>
								</div>
								<p class="f1"
									style="text-align: center; height: 36px; margin-top: 15px;">
									<a
										href="<%=path%>/goods/goodsDetailQian?id=${goods.id }&cid=${goods.catelogId}"
										title="${goods.mingcheng }">${goods.mingcheng }</a>
								</p>
								<p class="f1">
									已售出 ${goods.xl } 
								</p>
								<font class="f1"> ${goods.shichangjia }元 </font>
							</div>
