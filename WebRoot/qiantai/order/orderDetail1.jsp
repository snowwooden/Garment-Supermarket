  ...
  <form action="<%=path%>/pinglun/pinglunAdd" method="post">
     <table cellspacing="1" cellpadding="0" width="100%" border="0" bgcolor="#F7F3F7">
		  ...
		  <tr class="text"   bgcolor="#FFFFFF">
			  ...
			  <td>商品名称:${orderItem.goods.mingcheng}</td>
			   <input type="hidden"  name="gid${status.index}" value="${orderItem.goods.id}"/>
		  </tr>
		  <tr class="text"   bgcolor="#FFFFFF">
		   
			  <td>评论内容<textarea name="plnr${status.index}" rows="8" cols="80">默认好评</textarea> </td>
