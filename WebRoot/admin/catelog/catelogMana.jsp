	...
	<head>
        ...
        <script language="javascript">
           function catelogDel(id)
           {
               if(confirm('您确定删除吗？'))
               {
                   window.location.href="<%=path %>/catelog/catelogDel?id="+id;
               }
           }
           
           function catelogAdd()
           {
                 var url="<%=path %>/catelog/tocatelogAdd";
			...
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#11a8f1" align="center" style="margin-top:8px">
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
						...
						<a class="pn-loperator" href="<%=path %>/catelog/catelogEditPre?id=${catelog.id}">修改</a>
					</td>
				</tr>
				</c:forEach>
			</table>
