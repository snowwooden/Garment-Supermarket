...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
           function goodsDel(id)
           {
               if(confirm('您确定删除吗？'))
               {
                   window.location.href="<%=path %>/goods/goodsDel?id="+id;
               }
           }
           ...
           {
                 var url="<%=path %>/goods/goodsDetailHou?id="+id;
                 var n="";
                 var w="480px";
                 var h="500px";
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/img/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#11a8f1" align="center" style="margin-top:8px">
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="8" background="<%=path %>/img/tbg.gif">&nbsp;商品管理&nbsp;</td>
				</tr>
		 ...
		 <td width="7%">库存</td>
				...
				<tr align='center' bgcolor="#FFFFFF">
					...
					<td bgcolor="#FFFFFF" align="center"><a target="_blank" href="<%=path%>/goods/goodsDetailQian?id=${goods.id}&cid=${goods.catelogId}"   class="pn-loperator">商品介绍</a></td>
			 ...
			 <td bgcolor="#FFFFFF" align="center">${goods.kucun}</td>
					<td bgcolor="#FFFFFF" align="center">
						...
						<a class="pn-loperator" href="<%=path %>/goods/goodsEditPre?id=${goods.id}">修改</a>
					</td>
				</tr>
				</c:forEach>
			</table>
